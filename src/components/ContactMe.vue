<template>
  <div>
    <h1 class="uppercase text-3xl font-bold text-center mt-20">&lt;Contact Me /&gt;</h1>

    <div class="max-w-md py-4 px-8 shadow-2xl rounded-lg mt-4 mx-auto mb-20">
      <div>
        <p class="mt-2 text-center text-xl">Get in touch!</p>
      </div>
